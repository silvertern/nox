...
public class OSGiJarManifest extends DefaultManifest {
	...
	@BuildAPI @Nullable public ManifestSpec spec = null;

	@BuildAPI @Nullable public File from = null;
	...
	@BuildAPI public void spec(@Nonnull String symbolicName, @Nonnull Object version,
	...
	@BuildAPI public void spec(@Nonnull Project project, @Nullable Closure<?>... configs) {
	...
	@BuildAPI public String toSymbolicName(@Nonnull String groupId, @Nonnull String artifactId) {
